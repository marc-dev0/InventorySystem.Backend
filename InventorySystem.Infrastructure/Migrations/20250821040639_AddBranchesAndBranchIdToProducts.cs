...
{
    /// <inheritdoc />
    public partial class AddBranchesAndBranchIdToProducts : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                table: "Branches",
                columns: new[] { "Id", "Active", "Address", "Code", "CreatedAt", "Description", "Email", "IsDeleted", "Name", "Phone", "UpdatedAt" },
                values: new object[,]
                {
                    { 1, true, null, "TANT", new DateTime(2025, 8, 21, 4, 6, 38, 471, DateTimeKind.Utc).AddTicks(3669), "Sucursal principal Tantamayo", null, false, "Sucursal Tantamayo", null, null },
                    { 2, true, null, "MAIN", new DateTime(2025, 8, 21, 4, 6, 38, 471, DateTimeKind.Utc).AddTicks(5189), "Sucursal central", null, false, "Sucursal Principal", null, null }
                });
