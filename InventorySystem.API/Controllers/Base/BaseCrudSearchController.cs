...
/// <summary>
/// Base controller that provides both CRUD and search functionality
/// </summary>
...
public abstract class BaseCrudSearchController<TDto, TCreateDto, TUpdateDto> : ControllerBase
{
    /// <summary>
    /// Gets all entities
    /// </summary>
